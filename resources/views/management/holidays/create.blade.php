...
<style>
    ...
    @media (max-width: 768px) {
        .add-header { padding: 16px; }
        .add-header .header-title { font-size: 16px; }
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap items-center justify-between">
                <div>
                    <div class="header-title">
                        <i class="fas fa-calendar-plus text-indigo-300 mr-2"></i> Add Holiday
                    </div>
        ...
        <div class="form-card">
            <div class="card-header">
                <i class="fas fa-plus-circle"></i> Holiday Details
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('holidays.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="date" required 
                               class="form-control" 
                               value="{{ old('date') }}">
                        <div class="helper-text">Select the date this holiday falls on</div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            ...
                            <label>
                                Recurring annually
                                <span class="helper-text">(e.g., Christmas every year)</span>
                            </label>
                        </div>
                    </div>
